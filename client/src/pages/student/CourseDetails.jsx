  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-35 px-8 md:pt-30 pt-20 text-left">
                            ...
                            <div className='flex gap-2'>
                              {lecture.isPreviewFree && (
                                <p onClick={() => setPlayerData({
                                  videoId: lecture.lectureUrl.split('/').pop(), // videoId is the last part of the URL, which is then extracted from split and pop(takes last part).
        ...
        {/* right column */}
        <div className="course-card custom-card z-10 rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {
            playerData ?
